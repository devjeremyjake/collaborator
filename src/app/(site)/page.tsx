  ...
  return (
    <>
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
        ...
        <TitleSection
          title="Keep track of your collaboartions all in one place"
          subheading="Capture your ideas, thoughts, and meeting notes in a single place"
          pill="Features"
        />
        <div
          className="
        ...
        "
        >
          <Image alt="Banner" src={Calender} className="rounded-1xl" />
        </div>
      </section>
      <section className="relative">
        ...
        <div className="mt-20 px-4 sm:px-6 flex flex-col overflow-x-hidden overflow-visible">
          <TitleSection
            ...
            subheading="Join thousands of satisfied users and accomplish your personal and professional productivity needs"
            pill="Testimonials"
          />
